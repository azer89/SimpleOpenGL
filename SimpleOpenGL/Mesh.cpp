...
void Mesh::SetupMesh()
{
	...
	glVertexAttribIPointer(5, 4, GL_INT, sizeof(MVertex), (void*)offsetof(MVertex, m_BoneIDs));

	// Weights
	glEnableVertexAttribArray(6);
	glVertexAttribPointer(6, 4, GL_FLOAT, GL_FALSE, sizeof(MVertex), (void*)offsetof(MVertex, m_Weights));
	glBindVertexArray(0);
}